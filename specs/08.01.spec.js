...
describe("08.01", function () {
  ...
  it("08.01", async function () {
    ...
    await documentType.DocEngIz();
    await baseFields.base("08.01", "2011-01-31");
    await additionFields.typestudy();
    await additionFields.organizationtraining();
