...
describe("13.07", function () {
  ...
  it("13.07", async function () {
    ...
    await documentType.DocAboutZakExpertize();
    await baseFields.base("13.07", "2011-05-05");
    await additionFields.docexpertize("2007-01-01");
